...
export declare function checkout(ctx: RepoContext, state: RepoState, { branch }: {
    branch: string;
}): Promise<void>;
/**
 * Checkout a branch
 ...
 * console.log('done')
 */
export declare function _checkout({ fs, onProgress, dir, gitdir, remote, ref: _ref, filepaths, noCheckout, noUpdateHead, dryRun, force, track, cache, }: any): Promise<void>;
