...
const { walk, // _walk expects cache to always exist.
TREE, WORKDIR, STAGE, isIgnored, } = isoGit;
...
export async function statusList(ctx, state, statusArg) {
 ...
 */
export async function _statusList({ fs, ensureFirstBatch, dir = "/", gitdir = join(dir, ".git"), ref = "HEAD", filepaths = ["."], filter, sparseFilter, // experimental, not yet exposed as lix api!
